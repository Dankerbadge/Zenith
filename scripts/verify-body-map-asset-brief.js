...
function main() {
  ...
  const required = [
    ...
    { name: 'heading: Review Scoring Order', re: /^##\s+Review Scoring Order\b/im },
    ...
    { name: 'token: strict 90° side-profile', re: /strict\s+90[°º]?\s+side-profile/i },
    { name: 'token: Base-only silhouette', re: /base-only silhouette/i },
