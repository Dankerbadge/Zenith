...
\restrict FSq86oPmyTDjHLkcAm9c4RqHl0azYUUk5MEboX7IGvPhtDmhqUr5RLhY6lsoG7j
...
logical_backup	2026-02-11 07:26:12.728999+00	{"source": "run-backend-maintenance.sh"}
food_search_maintenance	2026-02-11 22:15:00.165037+00	{"purged_cache": 0, "purged_prefix": 0, "purged_rate_limit": 0}
\.
...
--
-- Data for Name: user_state_snapshots; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.user_state_snapshots (id, user_id, state_key, state_value, updated_at) FROM stdin;
\.
...
--
-- Name: user_state_snapshots user_state_snapshots_user_id_state_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.user_state_snapshots
    ADD CONSTRAINT user_state_snapshots_user_id_state_key_key UNIQUE (user_id, state_key);
...
--
-- Name: user_state_snapshots_user_updated_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX user_state_snapshots_user_updated_idx ON public.user_state_snapshots USING btree (user_id, updated_at DESC);
...
ALTER TABLE ONLY public.user_state_snapshots
    ADD CONSTRAINT user_state_snapshots_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
--
-- Name: user_state_snapshots; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.user_state_snapshots ENABLE ROW LEVEL SECURITY;

--
-- Name: user_state_snapshots user_state_snapshots_delete_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_state_snapshots_delete_own ON public.user_state_snapshots FOR DELETE TO authenticated USING ((auth.uid() = user_id));


--
-- Name: user_state_snapshots user_state_snapshots_insert_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_state_snapshots_insert_own ON public.user_state_snapshots FOR INSERT TO authenticated WITH CHECK ((auth.uid() = user_id));


--
-- Name: user_state_snapshots user_state_snapshots_select_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_state_snapshots_select_own ON public.user_state_snapshots FOR SELECT TO authenticated USING ((auth.uid() = user_id));


--
-- Name: user_state_snapshots user_state_snapshots_update_own; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY user_state_snapshots_update_own ON public.user_state_snapshots FOR UPDATE TO authenticated USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
GRANT ALL ON TABLE public.user_state_snapshots TO anon;
GRANT ALL ON TABLE public.user_state_snapshots TO authenticated;
GRANT ALL ON TABLE public.user_state_snapshots TO service_role;
...
\unrestrict FSq86oPmyTDjHLkcAm9c4RqHl0azYUUk5MEboX7IGvPhtDmhqUr5RLhY6lsoG7j
